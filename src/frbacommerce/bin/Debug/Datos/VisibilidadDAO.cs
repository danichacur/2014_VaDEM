...
namespace FrbaCommerce.Datos
{
    class VisibilidadDAO
    {
        ...
        /// <summary>
        /// obtiene las visibilidades en Habilitadas
        /// </summary>
        /// <param name="script"></param>
        /// <returns></returns>
        public static List<Visibilidad> obtenerVisibilidadesHabilitadas()
        {
            Visibilidad visib;
            List<Visibilidad> visibilidadeses;
            DataTable tblVisibilidades;
            try
            {
                ...
                String script = "SELECT * FROM vadem.visibilidad WHERE Habilitado = 1";
